...
### 2.2.4.2. Diagrama de Sequências Final

<p align="center"><b>Figura 5: </b>Diagrama de Sequências Final</p>
...
| :----: | ---------- | ---------------------------           | ----------------------------------------------------- | ----------------------------------------------------- |
| `1.0`  | 19/09/2025 | Criação do documento e documentação   |  [Arthur](https://github.com/Tutzs)                   | [Amanda Cruz](https://github.com/mandicrz)            |
| `1.1`  | 21/09/2025 | Adição de diagramas, formatação e documentação |  [Amanda Cruz](https://github.com/mandicrz)  | [Arthur](https://github.com/Tutzs)                    | 
| `1.1`  | 21/09/2025 | Adição de do diagrama de atividades unificado |  [Arthur](https://github.com/Tutzs)  | [Amanda Cruz](https://github.com/mandicrz)                     |